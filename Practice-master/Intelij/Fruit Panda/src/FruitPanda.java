...
public class FruitPanda {
    public static void main(String[] args) {
        ...
        User buyer = new Buyer("Farhan", "Tausif", "01305584050", "Matikata");
        Order order = ((Buyer) buyer).placeOrder( (Seller) seller);
        System.out.println(((Seller) seller).getFruitList());
        System.out.println(order.getFruitList());
        System.out.println(order.getQuantityInKgList());
